...
"""
    ...
    def "calling `Task.execute()` is deprecated"() {
        ...
        then:
        output.contains("The TaskInternal.execute() method has been deprecated.")
    }
    ...
    def "#description `Task.executer` is deprecated"() {
        ...
        then:
        output.contains("The TaskInternal.executer property has been deprecated.")
    ...
    def "calling `Task.deleteAllActions()` is deprecated"() {
        ...
        then:
        output.contains("The Task.deleteAllActions() method has been deprecated.")
    }
}
