...
public class JavaLibrary implements SoftwareComponentInternal {
    ...
    public JavaLibrary(PublishArtifact jarArtifact, DependencySet runtimeDependencies) {
        SingleMessageLogger.nagUserOfDeprecatedThing("A constructor for `org.gradle.api.internal.java.JavaLibrary` is used by Shadow plugin v1.2.x, and has been preserved for compatibility",
